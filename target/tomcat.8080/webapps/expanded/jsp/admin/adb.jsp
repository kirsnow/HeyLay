				...
				<section>
					<div id="container">
						<div class="row marginTop60">
							<form id="contentForm" class="form-horizontal " method="post" enctype="multipart/form-data">
								<div class="form-group">
									<div class="col-md-6 col-md-offset-3">
										<textarea name="adCode" class="form-control marginBottom" rows="4" placeholder="광고 코드" title="광고 코드 입력 폼"></textarea>
										<div class="row">
								           <div class="col-md-12">
								               <div class="input-group  ">
									                 <input type="text" name="account" class="form-control" placeholder="광고 위치" alt="광고 코드 들어갈 위치 작성 폼"/>
						...
						<div class="row  marginTop">
							<div class="col-md-2">
								<input type="checkbox" onclick="" id="allCheck"  alt="전체 선택" />
								...
								<table class="table">
									...
									<tbody>
										<c:forEach begin="1" end="10">
											<tr>
												<td><input type="checkbox" alt="삭제할 광고 선택 체크 박스"/></td>
												<td>1</td>
												<td class="col-md-8">갱장히 어마무시한 약간 그 옛날의 축전인 듯 축전 아닌 축전같은 코드가 들어갈 예정입니다.</td>
