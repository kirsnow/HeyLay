...
<head>
	...
	<title>유해 게시글 신고 | Quration: 답을 열어 줄 그런 사람</title>
...
<body>
	...
	<header>
  	...
  	<!-- 유해게시물 신고 신고 Section -->
	<section id="spam" class="body">
	 	<div class="container marginTop60 sectionContent">
	 		<div class="page-header text-center col-md-6 col-md-offset-3 marginBottom">
 		 		<h1>신고합니다 <small>유해 게시글 신고</small></h1>
           	</div>
            <form name="spamForm" action="${ pageContext.request.contextPath }/contact/spamMemo.do" method="post" 
				...
				<div class="row">
					<div class="col-md-6 col-md-offset-3 marginTop">
						<input type="text" name="memoNo" class="form-control" placeholder="유해 게시글 번호" alt="유해 게시글  번호"/>
					</div>
				</div>
				<div class="row">
                  <div class="col-md-6 col-md-offset-3 marginTop">
				...
				<div class="row">
					<div class="col-md-6 col-md-offset-3 marginBottom">
						<textarea name="userInput" class=" col-md-6 form-control marginTop" rows="10" 
						          placeholder="유해 게시글 신고 내용"></textarea>
					</div>
				</div>	
				<div class="row">
