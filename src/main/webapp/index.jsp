					...
					<c:when test="${ not empty userVO }">
						<div class="dropdown marginTop20 marginRight30">
							<c:choose>
								...
								<c:otherwise>
									<span class="marginRight"> <a
										...
										title="내카드"> <i class="fa fa-address-card-o"
											aria-hidden="true"></i> 내 카드
									</a>
									</span>
								</c:otherwise>
							</c:choose>
							...
							<a href="#" class="dropdown-toggle" data-toggle="dropdown"
								role="button" aria-expanded="false" title="회원 정보 메뉴 열기"> <img
								id="blah"
								src="${ pageContext.request.contextPath }/img/${userVO.profileImg}"
								alt="your image" class="img-circle profile_img"
								style="width: 30px; height: 30px;" /> <span class="caret"></span>
							</a>
...
=======
>>>>>>> 4079d2e36d9b19871bf59bfa5260f82d000f1b97
  </style>
  </head>
  <body>
    <!-- Home Section -->
...
>>>>>>> 4079d2e36d9b19871bf59bfa5260f82d000f1b97
							...
							<div class="marginTop20">
								<div class="pull-right ">
									<span><a
										...
										class="marginRight"> 회원가입</a> </span> <span><a
										href="<c:url value="/login/login.do" />" class=""> 로그인</a> </span>
								</div>
							</div>
						</div>
					</c:otherwise>
		...
		<div id="quration" class="container text-center">
			...
			<div class="content row">
				<form class="form-inline"
					...
					<div class="form-group row">
						<div class="input-group col-md-12">
							<div>
								<input type="search" style="background-color: transparent"
									size="60" name="q" class="form-control input-lg" alt="검색어 입력"
									value="${ searchQuery }" placeholder="검색어 입력" /> <span>
									<button type="submit"
										class="btn btn-primary input-lg btn-border-main" title="검색 실행">
				...
				<div id="recommandKeyword"
					class="col-md-8 col-md-offset-2 marginTop20 font20 grayfont">
					추천 검색어<span class="marginLeft marginRight">:</span> <span
						class="spanPadding"><a href="search/result.do?q=인공지능">인공지능</a></span>
					<span class="spanPadding"><a href="search/result.do?q=에듀테크">에듀테크</a></span>
					<span><a href="search/result.do?q=프로그래밍 언어에 대하여">프로그래밍
							언어에 대하여</a></span>
				</div>
<<<<<<< HEAD
=======
				...
				<div class="col-md-4 col-sm-4">
					<div class="service">
						...
						<p class="text-justify">
							<span class="text-primary"><b>검색 </b></span>기능으로 다양한 플랫폼을 통해 원하느
							정보를 찾을 수 있게 자료를 제공합니다. 뿐만아니라, 저희 서비스 속 큐레이션 기능이 더해져 검색 정확도와 검색
							속도가 상승하여 사용자가 느끼는 검색 품질이 향상됩니다.
...
>>>>>>> a56c2602e021ad86e455fc906b39d226a71dfd52
				...
				<div class="col-md-4 col-sm-4">
					<div class="service">
						...
						<h4>Curation</h4>
						<p class="text-justify">
							<span class="text-primary"><b>큐레이션</b></span>은 무수하게 쏟아져 나오는 자료
							중에서 의미 있는 자료를 선별해 주는 것을 말합니다. 저희 서비스에서는 사용자가 선택한 관심 키워드와 콘텐츠 검색,
							저장, 좋아요 수를 조합하여 추천 서비스를 제공합니다.
						</p>
					</div>
				</div>
				...
				<div class="col-md-4 col-sm-4">
					<div class="service">
						...
						<h4>Web reference</h4>
						<p class="text-justify">
							<span class="text-primary"><b>웹 레퍼런스</b></span>기능 은 사용자가 찾은 콘텐츠 중
							마음에 드는 콘텐츠를 즐겨찾기 처럼 저장하고 메모를 남길 수 있는 기능입니다. 콘텐츠가 저장된‘내 서랍’ 기능을
							사용하면, 언제 어디서나 콘텐츠를 다시 볼 수 있습니다.
						</p>
					</div>
				</div>
			</div>
			...
			<a href="#about-us" class="down-btn page-scroll "> <span
				class="fa fa-angle-down"></span>
			</a> <a href="#main" class="up-btn page-scroll "> <span
...
<<<<<<< HEAD
	<div class="container">
		<div style="position: relative; height: 0; padding-bottom: 56.25%">
			<iframe
				src="https://www.youtube.com/embed/cBEePEmikZs?controls=0&amp;showinfo=0?ecver=2"
		...
		<div class="container">
			<div class="row text-center">
				<div class="col-md-14">
					...
					<p class="grayfont">Question&nbsp;&nbsp;+&nbsp;&nbsp;Curation =
						Qurtion&nbsp;&nbsp;</p>
				</div>
			</div>
			<div class="space"></div>
				...
				<div class="col-md-12 col-sm-10">
					<div class="row">
						<div class="col-md-3 col-sm-3">
							<div class="team">
								<img src="${ pageContext.request.contextPath }/img/evee.png"
						...
						<div class="col-md-3 col-sm-3">
							<div class="team">
								<img src="${ pageContext.request.contextPath }/img/purin.png"
									class="img-responsive img-circle" alt="..."> <br>
								<h4>Shin Hanui</h4>
						...
						<div class="col-md-3 col-sm-3">
							<div class="team">
								<img src="${ pageContext.request.contextPath }/img/paeri23.png"
									class="img-responsive img-circle" alt="..."> <br>
						...
						<div class="col-md-3 col-sm-3">
							<div class="team">
								<img src="${ pageContext.request.contextPath }/img/mue.png"
									class="img-responsive img-circle" alt="..."> <br>
    	...
    	<div class="overlay">
	    	<div class="container">
		        <iframe id="player" type="text/html" width="610" height="360"
						src="https://www.youtube.com/embed/U_0irucRNFA" style="border:0px">
				</iframe>
			</div>
		</div>
    </div>
...
>>>>>>> a56c2602e021ad86e455fc906b39d226a71dfd52
					...
					<a href="#services" class="up-btn page-scroll"> <span
						class="fa fa-angle-up"></span>
					</a>
				</div>
...
>>>>>>> 4079d2e36d9b19871bf59bfa5260f82d000f1b97
	...
	<script type="text/javascript"
		src="${ pageContext.request.contextPath }/js/SmoothScroll.js"></script>
	<script type="text/javascript"
		src="${ pageContext.request.contextPath }/js/typed.js"></script>
	...
	<script>
		$(function() {
			$("#head-title").typed(
					{
						strings : [ "Java^1000", "Python^1000",
								"JavaScript^1000", "PHP^1000",
								"Objective-C^1000" ],
						typeSpeed : 100,
						loop : true,
						startDelay : 100
